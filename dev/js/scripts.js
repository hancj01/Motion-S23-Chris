...
function blocksAnimation(){
    ...
    tl.from("#top-s-block", {duration: 0.2, scaleX:0, ease: "none", transformOrigin: "right" }, "grow")
    tl.from("#o-1-block, #o-2-block", {duration: 0.2, scaleX:0, ease: "none", transformOrigin: "center" }, "grow")
    tl.from("#top-h-block", {duration: 0.2, scaleX:0, ease: "none", transformOrigin: "top" }, "grow")    
    tl.from("#bottom-h-block", {duration: 0.2, scaleX:0, ease: "none", transformOrigin: "bottom" }, "grow")    
